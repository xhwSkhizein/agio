    ...
    async def execute(
        ...
        while current_step < self.config.max_steps:
            ...
            if assistant_step.metrics:
                ...
                if first_token_time:
                    assistant_step.metrics.first_token_latency_ms = (first_token_time - step_start_time) * 1000
            ...
            # Add to messages
            messages.append(assistant_step.to_message_dict())
            current_sequence += 1
            ...
            for result in results:
                ...
                # Add to messages
                messages.append(tool_step.to_message_dict())
                current_sequence += 1
