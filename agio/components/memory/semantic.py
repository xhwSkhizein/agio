...
from agio.components.memory.base import AgentMemoriedContent, Memory, MemoryCategory, SemanticMemoryManager
        ...
        for text in results:
            ...
            memories.append(
                AgentMemoriedContent(
                    content=text, category=MemoryCategory.OBSERVATION, importance=0.5  # Default
                )
            )
