...
class ToolRegistry:
    ...
    BUILTIN_TOOLS: dict[str, tuple[str, str]] = {
        # File operations
        "file_read": (
            "agio.providers.tools.builtin.file_read_tool",
            "FileReadTool",
        ),
        "file_edit": (
            "agio.providers.tools.builtin.file_edit_tool",
            "FileEditTool",
        ),
        "file_write": (
            "agio.providers.tools.builtin.file_write_tool",
            "FileWriteTool",
        ),
        # Search tools
        "grep": (
            "agio.providers.tools.builtin.grep_tool",
            "GrepTool",
        ),
        "glob": (
            "agio.providers.tools.builtin.glob_tool",
            "GlobTool",
        ),
        "ls": (
            "agio.providers.tools.builtin.ls_tool",
            "LSTool",
        ),
        # System tools
        "bash": (
            "agio.providers.tools.builtin.bash_tool",
            "BashTool",
        ),
        # Web tools
        "web_search": (
            "agio.providers.tools.builtin.web_search_tool",
            "WebSearchTool",
        ),
        "web_fetch": (
            "agio.providers.tools.builtin.web_fetch_tool",
            "WebFetchTool",
        ),
    }
